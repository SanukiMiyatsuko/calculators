...
import { extendedSideWorm } from "./Definition";

const ExtendedSideWorm = () => {
  return (
    <>
      <main className={styles.main}>
        <h1 className={styles.subHead}>拡張横ベクレミシェフ計算機</h1>
...
export default ExtendedSideWorm;
