...
import styles from "./otherTwoVariablesPsi.module.css";
...
const Page = ({
  ...
  const handleOperation = (op: Operation) => {
    ...
    try {
      ...
      const z = inputC ? parseInt(inputC) : null;
      ...
      switch (op) {
        case "lessThan": {
          ...
          const result = abbreviateAndKatex(hyoki.fund(x.term, y.term, z));
          updateOutput(
            `${x.str}[${y.str}]`,
            `${x.katex}[${y.katex}]`,
            result.str,
