    ...
    try {
      ...
      switch (op) {
        case "lessThan": {
          ...
          if (!inputD)
            throw new Error("Dを入力してください");
          const z = parseInt(inputD);
          const output = hyoki.expand(listx, y, z);
          ...
          setPrintInput(`expand(${strx}, ${y}, ${z})`);
          setPrintInputKatex(`\\text{expand}(${strx}, ${y}, ${z})`);
